...
<head>
    ...
    <title>Perbarui Prestasi &mdash; Admin EEPROM</title>
</head>
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
          <h3>Perbarui Prestasi</h3>
          <br>
          <form action="<?php echo base_url() . "index.php/prestasi/proses_perbarui_prestasi"; ?>" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama_prestasi" required="required" value="<?php echo $prestasi[0]['nama_prestasi']; ?>">
            </div>
