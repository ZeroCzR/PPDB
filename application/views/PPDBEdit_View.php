...
<section id="contact">
  <div class="container">
    <?php 
      echo form_open_multipart('Ppdb_Controller/edit_news/'.$show_ppdb['id_user']);
    ?>
    <div class="well well-sm">
      <h3><strong>News</strong></h3>
    </div>
        <label>Username</label>
        <input type="text" class="form-control" value="<?php echo $show_ppdb['username']?>" name="username"><br>
        <label>Password</label>
        <input type="text" class="form-control" value="<?php echo $show_ppdb['password']?>" name="password"><br>
        <label>Level</label>
